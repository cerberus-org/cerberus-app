...
import { authReducers } from '../app/auth/store/reducers/index';
import { initialSessionReducerState } from '../app/auth/store/reducers/session.reducer';
import { rootReducers } from '../app/core/store/reducers/index';
import { initialModelReducerState } from '../app/core/store/reducers/model.reducer';
import { settingsReducers } from '../app/settings/store/reducers/index';
import { signUpReducers } from '../app/sign-up/store/reducers/index';
import { initialGettingStartedReducerState } from '../app/sign-up/store/reducers/getting-started.reducer';
